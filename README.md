...
| --------- | --------------------------------------------- | -------- | -------------- |
| `address` | IP address and port the web server listens on | Yes      | 127.0.0.1:8000 |
...
- `token`: The [personal access token](https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/managing-your-personal-access-tokens#creating-a-token)
  's lifetime should be less than one year for security purposes. Minimum required
...
| Field     | Description                                     | Required | Default          |
| --------- | ----------------------------------------------- | -------- | ---------------- |
| `db_path` | Folder where the sled database files are stored | Yes      | github-dashboard |
