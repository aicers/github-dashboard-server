...
pub async fn build_rag_graph() -> anyhow::Result<Arc<graph_flow::Graph>> {
    ...
    let vector_search = Arc::new(vector_search::VectorSearchTask::new(vector_db.clone()));
    ...
    */
    ...
    let graph = GraphBuilder::new("github_rag_workflow")
        ...
        // .add_edge(segment_parser.id(), graphql_generator.id())
        ...
        // .add_edge(context_reranking.id(), statistics_response.id())
