            ...
            if let Some(repository) = data.repository {
                if let Some(nodes) = repository.pull_requests.nodes {
                    ...
                    for pr in nodes.into_iter().flatten() {
                        ...
                        let assignees_conn = assignees_list;
                        ...
                        prs.push(GitHubPullRequestNode {
                            ...
                            Some(PullRequestAuthorUser(user)) => user.login.clone(),
                            _ => String::new(),
                        },
                            ...
                            review_decision: pr.review_decision.clone().and_then(|d| match d {
